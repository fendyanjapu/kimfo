...
<div class="herocontent">
    <div class="row justify-content-center">
        <div class="col-md-8 shadow-xl bg-white rounded">
            <form action="{{ route('updateUraianSubkegiatan', $getid->id_rencana_kas) }}" class="px-5 py-5" method="post">
                @csrf
                @method('PUT')
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select @error('id_data') is-invalid @enderror" name="id_data" id="id_program" required>
                            ...
                            <option value="{{ $row->id_program }}" {{ $row->id_program == $getid->id_program ? 'selected' : '' }}>{{ $row->program }}</option>
                            @endforeach
                        </select>
                        @error('id_data')
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select @error('id_kegiatan') is-invalid @enderror" name="id_kegiatan" id="id_kegiatan" required>
                            <option value="{{ $k->id_kegiatan }}">{{ $k->kegiatan }}</option>
                        </select>
                        @error('id_kegiatan')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select @error('id_subkegiatan') is-invalid @enderror" name="id_subkegiatan" id="id_subkegiatan" required>
                            <option value="{{ $sk->id_subkegiatan }}">{{ $sk->subkegiatan }}</option>
                        </select>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <select class="form-select @error('Uraian') is-invalid @enderror" name="Uraian" id="Uraian" required>
                            <option value="{{ $u->id_uraian_subkegiatan }}">{{ $u->uraian }}</option>
                        </select>
                        @error('Uraian')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ $getid->triwulan_i }}" class="form-control @error('triwulan_i') is-invalid @enderror" name="triwulan_i">
                    </div>
                    @error('triwulan_i')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ $getid->triwulan_ii }}" class="form-control @error('triwulan_ii') is-invalid @enderror" name="triwulan_ii">
                    </div>
                    @error('triwulan_ii')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ $getid->triwulan_iii }}" class="form-control @error('triwulan_iii') is-invalid @enderror" name="triwulan_iii">
                    </div>
                    @error('triwulan_iii')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" value="{{ $getid->triwulan_iv }}" class="form-control @error('triwulan_iv') is-invalid @enderror" name="triwulan_iv">
                    </div>
                    @error('triwulan_iv')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
