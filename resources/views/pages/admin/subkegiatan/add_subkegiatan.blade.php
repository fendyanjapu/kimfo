...
<div class="herocontent">
    <div class="row justify-content-center">
        <div class="col-md-8 shadow-xl bg-white rounded">
            <form class="px-5 py-5" action="{{ route('rfk_subkegiatan.store')}}" method="post">
                @csrf
                    ...
                    <div class="col-sm-8">
                        <div class="row" style="margin-left:-12px">
                            ...
                            <div class="col-sm-4 mt-2">
                                <input type="text" class="form-control" id="kegiatan_kode" readonly>
                            </div>
                            <div class="col-sm-4 mt-2">
                                <input type="text" class="form-control" name="subkegiatan_kode" id="subkegiatan_kode">
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="subkegiatan_sasaran">
                    </div>
                </div>
                <div class="form-group row mt-3">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="subkegiatan_indikator_kinerja">
                    </div>
                </div>
                <div class="form-group row mt-3">
