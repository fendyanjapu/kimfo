...
<div class="herocontent">
    <div class="row justify-content-center">
        <div class="col-md-8 shadow-xl bg-white rounded">
            <form class="px-5 py-5" action="{{ route('jabatan.store')}}" method="post">
                @csrf
                
                <div class="form-group row mt-3">
                    <label class="col-sm-4 control-label">Nama Jabatan</label>
                    <div class="col-sm-8">
                        <input type="text" style="width:100%" name="nama_jabatan" class="form-control @error('nama_jabatan') is-invalid @enderror" id="nama" required/>
                        @error('nama_jabatan')
