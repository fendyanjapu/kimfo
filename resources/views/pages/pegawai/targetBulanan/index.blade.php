...
@section('content')
  ...
  <a href="{{ route('targetBulanan.create') }}" class="btn btn-primary mb-4" title="Tambah"><i
  ...
  <table id="tabel" class="table table-striped table-bordered">
    ...
    <tr>
      ...
      <a href="{{ route('targetBulanan.edit', ['targetBulanan' => $item]) }}" class="btn btn-success btn-sm mt-1"
      title="edit"><i class="icon-pencil"></i></a>

      {{-- <a href="{{ route('targetBulanan.destroy', $item->id) }}" class="btn btn-danger btn-sm mt-1"
