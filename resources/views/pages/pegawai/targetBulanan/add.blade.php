            ...
            <div class="col-md-8 shadow-xl bg-white rounded">
                <form class="px-5 py-5" action="{{ route('targetBulanan.store')}}" method="post">
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="jan" id="jan" class="form-control" value="0"
                                required />
                            @error('jan')
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="feb" id="feb" class="form-control" value="0"
                                required />
                            @error('feb')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="mar" id="mar" class="form-control" value="0"
                                required />
                            @error('mar')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="apr" id="apr" class="form-control" value="0"
                                required />
                            @error('apr')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="mei" id="mei" class="form-control" value="0"
                                required />
                            @error('mei')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="jun" id="jun" class="form-control" value="0"
                                required />
                            @error('jun')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="jul" id="jul" class="form-control" value="0"
                                required />
                            @error('jul')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="agu" id="agu" class="form-control" value="0"
                                required />
                            @error('agu')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="sep" id="sep" class="form-control" value="0"
                                required />
                            @error('sep')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="okt" id="okt" class="form-control" value="0"
                                required />
                            @error('okt')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="nov" id="nov" class="form-control" value="0"
                                required />
                            @error('nov')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="des" id="des" class="form-control" value="0"
                                required />
                            @error('des')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="jumlah" id="jumlah" class="form-control" value="0"
                                readonly />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-sm-8">
                            <input type="number" style="width:100%" name="target" id="target" class="form-control" value="0"
                                readonly />
                        </div>
                    </div>
